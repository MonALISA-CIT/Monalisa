...
public class New_CMS_FT extends cmdExec implements MonitoringModule, Observer {
    ...
    static public String ModuleName = "PhEDEx";
               ...
               if(D != null) {
                   ...
                   if (lastV != null) {
                       ...
                       if (diff >= 0) {
                           ...
                           System.out.println("\n [ " + new Date() + " ] !!!!!!! Negative diff [ " + key +" ] : LastValue =" + lastV + " New Value" + D +" diffValue = " + diffDouble + "    lastTime" + lastTime + " New Time " + r.time +" diffTime = " + diffTime + " \n");
                       }
                   }
