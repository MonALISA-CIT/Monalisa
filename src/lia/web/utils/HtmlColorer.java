...
public class HtmlColorer {
	...
	public static String highlightPattern(final String sLine, final Pattern p, final String sPreffix, final String sSuffix) {
		return highlightPattern(sLine, p, sPreffix, sSuffix, 0);
	}
	 ...
	 * @return formatted pattern
	 */
	public static String highlightPattern(final String sLine, final Pattern p, final String sPreffix, final String sSuffix, final int group) {
		final StringBuilder sb = new StringBuilder(sLine.length());
		...
		while (m.find(iLastIndex)) {
			final String sMatch = m.group(group);
	...
	public static void main(final String args[]) {
		...
		System.err.println(logLineColorer(
		...
		System.err.println(logLineColorer(
				"Jul 15 17:09:42  info	ID 2819798 Starting a transfer to castor://castorsrm.cr.cnaf.infn.it//castor/cnaf.infn.it/grid/lcg/alice/T1D0/14/41312/B3C55D9A-0E15-11DD-8618-00304851675C"));
	}
}
