...
//			nHeader++;
//		}
		//System.out.println("All initialisation done. Using monsit version @monsitVersion@ built at @monsitDate@.");
	}
...
//				}
		 ...
		 */
		hVariables.put( "monsitVersion", "@monsitVersion@");
		...
		hVariables.put( "monsitDate", "@monsitDate@");
	}
