...
public final class Sun
{
    ...
    private static final Date localDate;
    private static final int tzOffset;
    private static final double A = 0.065709799999999999D;
    private static final double B = 17.411472D;
    private static final double C = 1.0027379999999999D;
    ...
    static 
    {
        localDate = new Date(NTPDate.currentTimeMillis());
