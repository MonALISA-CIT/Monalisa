...
public class MultipleMonData3DPlotClusGlobal implements LocalDataFarmClient, MultipleDataPlotter, ActionListener,
        WindowListener, TimeSliderAdjustmentListener {

    /** Logger used by this class */
    private static final Logger logger = Logger.getLogger(MultipleMonData3DPlotClusGlobal.class.getName());
    ...
    public MultipleMonData3DPlotClusGlobal(DataPlotterParent parent, rcNode[] selectedNodes, Vector predicates,
            Vector clusters) {
        ...
        if (multipleFarms) {
            p = new XYLineChart("History Plot", "Local Time", " ", " ");
            localTimeZone = true;
        } else {
            p = new XYLineChart("History Plot", "Service Local Time", " ", " ");
