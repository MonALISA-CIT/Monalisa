...
public class MultipleMonDataPlotClus implements LocalDataFarmClient, MultipleDataPlotter, ActionListener,
        ComponentListener, WindowListener, TimeSliderAdjustmentListener {

    /** Logger used by this class */
    private static final Logger logger = Logger.getLogger(MultipleMonDataPlotClus.class.getName());
    ...
    public MultipleMonDataPlotClus(DataPlotterParent parent, rcNode[] selectedNodes, Vector predicates, Vector clusters) {
        ...
        if (multipleFarms) {
            p = new newSimPlot("Cluster History Plot", title, "Local Time", " ", true);
            localTimeZone = true;
        } else {
