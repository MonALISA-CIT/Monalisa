...
public class OpticalSwitchGraphPan extends JPanel implements MouseListener, MouseMotionListener, LayoutChangedListener,
        ActionListener {

    /**
     * 
     */
    private static final long serialVersionUID = -3290133355138614316L;

    /** The Logger */
    private static final Logger logger = Logger.getLogger(OpticalSwitchGraphPan.class.getName());
    ...
    private final BufferedImage telescentImage;
    private final BufferedImage glowTelescentImage;
    private final BufferedImage grayosTelescentImage;
    ...
    private final BufferedImage hostImage;
    private final BufferedImage glowHostImage;
    private final BufferedImage grayHostImage;
    private int hostImgWidth = 100;//set at loading iamge moment
    private int hostImgHeight = 40;//set at loading iamge moment

    private final BufferedImage cienaImage;
    private final BufferedImage glowCienaImage;
    private final BufferedImage grayCienaImage;
    private int cienaImgWidth = 42;//set at loading iamge moment
    private int cienaImgHeight = 56;//set at loading iamge moment

    private final BufferedImage force10Image;
    private final BufferedImage glowForce10Image;
    private final BufferedImage grayForce10Image;
    ...
    private OpticalSwitchGraphPan(OpticalSwitchPan gmapPan) {
        ...
        if (telescentImage != null) {
            telescentShadow = new BufferedImage(telescentosImgWidth + 14, telescentosImgHeight + 14,
    ...
    public void paintHostNode(Graphics g, rcNode n, FontMetrics fm) {
        ...
        g.setColor(Color.white);
        g.drawString(nodeName, (n.limits.x + 7 + wunit_host) - w2 - 1, n.limits.y - (fm.getAscent() / 2) - 1/*+ hunit - h2 + fm.getAscent()*/);
        g.drawString(nodeName, ((n.limits.x + 7 + wunit_host) - w2) + 1, (n.limits.y - (fm.getAscent() / 2)) + 1/*+ hunit - h2 + fm.getAscent()*/);
        g.setColor(new Color(0, 0, 77));
        if (n.equals(pickX)) {
            g.setColor(Color.red);
        }
        g.drawString(nodeName, (n.limits.x + 7 + wunit_host) - w2, n.limits.y - (fm.getAscent() / 2));
    ...
    public void paintCienaNode(Graphics g, rcNode n, FontMetrics fm) {
        ...
        g.setColor(Color.white);
        g.drawString(nodeName, (n.limits.x + 7 + wunit_ciena) - w2 - 1, n.limits.y - (fm.getAscent() / 2) - 1/*+ hunit - h2 + fm.getAscent()*/);
        g.drawString(nodeName, ((n.limits.x + 7 + wunit_ciena) - w2) + 1, (n.limits.y - (fm.getAscent() / 2)) + 1/*+ hunit - h2 + fm.getAscent()*/);
        g.setColor(new Color(0, 0, 77));
        if (n.equals(pickX)) {
            g.setColor(Color.red);
        }
        g.drawString(nodeName, (n.limits.x + 7 + wunit_ciena) - w2, n.limits.y
                - (fm.getAscent() / 2 /*+ hunit - h2 + fm.getAscent()*/));
    ...
    public void paintForce10Node(Graphics g, rcNode n, FontMetrics fm) {
        ...
        g.setColor(Color.white);
        g.drawString(nodeName, (n.limits.x + 7 + wunit_force10) - w2 - 1, n.limits.y - 1/*+ hunit - h2 + fm.getAscent()*/);
        g.drawString(nodeName, ((n.limits.x + 7 + wunit_force10) - w2) + 1, n.limits.y + 1/*+ hunit - h2 + fm.getAscent()*/);
        g.setColor(new Color(0, 0, 77));
        if (n.equals(pickX)) {
            g.setColor(Color.red);
        }
        g.drawString(nodeName, (n.limits.x + 7 + wunit_force10) - w2, n.limits.y /*+ hunit - h2 + fm.getAscent()*/);
    ...
    public void paintOSNode(Graphics g, rcNode n, FontMetrics fm) {
        ...
        //draw new OS
        if (gmapPan.kbShowShadow.isSelected()) {
            ((Graphics2D) g).drawImage(telescentShadow, blurOp, x - (telescentosImgWidth / 2), y
                    - (telescentosImgHeight / 2));
        }
        if (participatingRCNodes.contains(n)) {
        ...
        if (selectedNodes.contains(n)) {
            ...
            BasicStroke stroke = new BasicStroke(2.0f, b.getEndCap(), b.getLineJoin(), b.getMiterLimit(), new float[] {
                    ...
                    b.getDashPhase());
            g2.setStroke(stroke);
            g.drawRect(x - (telescentosImgWidth / 2), y - (telescentosImgHeight / 2), telescentosImgWidth,
                    telescentosImgHeight);
            g2.setStroke(b);
        }
        Graphics2D g2 = (Graphics2D) g;
        ...
        OSFrontImage.drawOSLeds(n, g2, (n.limits.x + (n.limits.width / 2)) - 35,
                (n.limits.y + (n.limits.height / 2)) - 5, 70, 10);

        g.setColor(Color.white);
        g.drawString(nodeName, (n.limits.x + 7 + wunit_os) - w2 - 1, n.limits.y - (fm.getAscent() / 2) - 1/*+ hunit - h2 + fm.getAscent()*/);
        g.drawString(nodeName, ((n.limits.x + 7 + wunit_os) - w2) + 1, (n.limits.y - (fm.getAscent() / 2)) + 1/*+ hunit - h2 + fm.getAscent()*/);
        g.setColor(new Color(0, 0, 77));
        if (n.equals(pickX)) {
            g.setColor(Color.red);
        }
        g.drawString(nodeName, (n.limits.x + 7 + wunit_os) - w2, n.limits.y
                - (fm.getAscent() / 2 /*+ hunit - h2 + fm.getAscent()*/));
        ...
        for (int i = 0; i < selectedNodes.size(); i++) {
            ...
            if ((obj = LTFNcontains(0, n)) != null) {
                ...
                if ((n1 != null) && (n1.client.osControl != null)) {
                    return n1.client.opticalSwitchControl;
                }
                continue;
            }
        ...
        if (n1.wconn != null) {
            for (Enumeration en = n1.wconn.keys(); en.hasMoreElements();) {
                ...
                if (obj instanceof OSLink) {
                    OSLink link = (OSLink) obj;
                    if ((link.szSourceOSPort != null)
                            && ((link.szSourceOSPort.type() == PortType.INPUT_PORT) || (link.linkID != null))) {
                        continue;
                    }
                ...
                if (LTFNcontains(0, next) != null) {
                    ...
                    if (next.getOpticalSwitch() != null) {
                        ...
                        if (ge instanceof OpticalSwitch) {
                            ...
                            if (l != null) {
                                for (lia.net.topology.Link element : l) {
                                    if (element.sourcePort().name().equals(destPort)) {
                                        nextPort = element.destinationPort().name();
                                        break;
                                    }
                                }
                            } else {
                ...
                if (LTFNcontains(0, sourceNode) != null) {
                    ...
                    if (sourceNode.getOpticalSwitch() != null) {
                        ...
                        if (ge instanceof OpticalSwitch) {
                            ...
                            if (l != null) {
                                for (lia.net.topology.Link element : l) {
                                    if (element.destinationPort().name().equals(sourcePort)) {
                                        previousPort = element.sourcePort().name();
                                        break;
                                    }
                                }
                            } else {
    ...
    public String formLinkToolTip(String linkID) {
        ...
        for (int i = 0; i < v.size(); i++) {
            ...
            if (link.szSourceOSPort != null) {
                if (link.szSourceOSPort.type() == PortType.INPUT_PORT) {
                    String key = link.szDestName + ":" + link.szDestPort;
                    p.put(key, new Object[] { link.szSourceName, link.szSourceOSPort.name(), link.rcDest,
                            link.rcSource, link.szDestName, link.szDestPort, getRFID(link.szSourceOSPort),
                            getRFID(link.szDestinationOSPort) });
                    ...
                    p.put(key, new Object[] { link.szDestName, link.szDestPort, link.rcSource, link.rcDest,
                            link.szSourceName, link.szSourceOSPort.name(), getRFID(link.szDestinationOSPort),
                            getRFID(link.szSourceOSPort) });
                        ...
                        if (ge instanceof OpticalSwitch) {
                            ...
                            if (l != null) {
                                for (lia.net.topology.Link element : l) {
                                    if (element.sourcePort().name().equals(destPort)) {
                                        nextPort = element.destinationPort().name();
                                        if (element.sourcePort() instanceof AFOXOSPort) {
                                            hasRFID |= (((AFOXOSPort) element.sourcePort()).getSerialNumber() != null);
                                        }
                                        break;
                                    }
                                }
                        ...
                        if (ge instanceof OpticalSwitch) {
                            ...
                            if (l != null) {
                                for (lia.net.topology.Link element : l) {
                                    if (element.destinationPort().name().equals(sourcePort)) {
                                        previousPort = element.sourcePort().name();
                                        if (element.destinationPort() instanceof AFOXOSPort) {
                                            hasRFID |= (((AFOXOSPort) element.destinationPort()).getSerialNumber() != null);
                                        }
                                        break;
                                    }
                                }
