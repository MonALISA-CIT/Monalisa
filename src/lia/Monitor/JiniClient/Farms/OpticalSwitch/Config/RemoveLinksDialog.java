...
public class RemoveLinksDialog extends JDialog implements ActionListener {
	...
	protected OpticalSwitchPan osPan;
	protected Color firstColor = new Color(255, 162, 153);
	Font f = new Font("Arial", Font.PLAIN, 10);
	
	public RemoveLinksDialog(final JFrame owner, final Hashtable links, final OpticalSwitchPan osPan) {
				...
				public void actionPerformed(ActionEvent e) {
					new Thread(new Runnable() {
						public void run() {
							...
							OpticalSwitchMonitorControl c = osPan.grapPan.getDelFirstMonitor();
