...
public class RadialLayoutAlgorithm extends lia.Monitor.JiniClient.CommonGUI.Gmap.RadialLayoutAlgorithm {

    // Temporary variables
	CienaNode rcRoot;
	
    public RadialLayoutAlgorithm(GraphTopology gt, CienaNode root) {
        super(gt, null);
        rcRoot = root;
    }
