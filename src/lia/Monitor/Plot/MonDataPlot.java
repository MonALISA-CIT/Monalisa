...
public class MonDataPlot implements LocalDataFarmClient, DataPlotter, ActionListener, ComponentListener,
        WindowListener, TimeSliderAdjustmentListener {

    /** Logger used by this class */
    private static final Logger logger = Logger.getLogger(MonDataPlot.class.getName());
