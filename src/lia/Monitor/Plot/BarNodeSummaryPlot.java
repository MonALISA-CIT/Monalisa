 ...
 * a cluster 
 */
public class BarNodeSummaryPlot implements LocalDataFarmClient, DataPlotter, ComponentListener, WindowListener,
        ActionListener {

    /** Logger used by this class */
    private static final Logger logger = Logger.getLogger(BarNodeSummaryPlot.class.getName());
    ...
    public BarNodeSummaryPlot(DataPlotterParent parent, LocalDataFarmProvider dataprovider, Vector predicates,
