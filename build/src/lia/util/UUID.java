package lia.util;
/*
 * This was added from java.util.UUID in java 1.5 to include an 
 * UUID generator for ML, still using java 1.4.
 * 
...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
    ...
    private UUID(byte[] data) {
        ...
        long lsb = 0;
        if(data.length != 16)
        	throw new IllegalArgumentException("The given data[] must have 16 bytes in lenght");
        for (int i=0; i<8; i++)
     ...
     *
     * @param  obj <tt>Object</tt> to which this <tt>UUID</tt> is to be compared.
     * @return -1, 0 or 1 as this <tt>UUID</tt> is less than, equal
     *         to, or greater than <tt>obj</tt>.
     */
