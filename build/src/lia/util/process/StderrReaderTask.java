/*
 * $Id: StderrReaderTask.java 6880 2010-10-13 06:34:23Z ramiro $
 *
 ...
 *
 */
public class StderrReaderTask extends InputStreamReaderTask {
     ...
     * @param saveLog
     */
    public StderrReaderTask(ExternalProcess externalProcess) {
        super(externalProcess.p.getErrorStream(), externalProcess.saveOutput, externalProcess);
    ...
    void newLines(String... lines) {
        if(hasNotifier) {
            notifier.notifyStdErr(externalProcess, Arrays.asList(lines));
        }
    }
