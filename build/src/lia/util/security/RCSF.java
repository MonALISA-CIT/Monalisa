...
public class RCSF implements RMIClientSocketFactory, Serializable {

    /**
     * @since ML 1.4.2
     */
    private static final long serialVersionUID = -3345084959957013768L;
    ...
    public int hashCode() {
        ...
        try {
            ...
            String sstore = AppConfig.getProperty("lia.Monitor.OS.SKeyStore");
            String spasswd = "monalisa";
    ...
    public RCSF(String keyStoreName) {
