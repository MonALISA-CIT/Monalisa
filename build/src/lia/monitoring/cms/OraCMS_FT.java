...
public class OraCMS_FT extends Observable implements Runnable {
    ...
    private String getSQLQuery() {
        ...
        synchronized (syncConf) {
            ...
            sb.append("SELECT UPDATE_STAMP, NODE, ");
    ...
    private boolean checkNewData(Connection conn) {
        try {
            ...
            if(rs.next()) {
                if(rs.getLong(1) > lastTime) return true;
            } else {
                return false;
            }
        }catch(Throwable t){
    ...
    public void run() {
        ...
        while (hasToRun) {
            ...
            System.out.println(" Dt = " + (NTPDate.currentTimeMillis() - sTime));
        }
    }
    ...
    public static void main(String[] args) {
        ...
        oft.setConf("jdbc:oracle:oci8:@pdb01", "cms_transfermgmt_reader", "slightlyjaundiced",
