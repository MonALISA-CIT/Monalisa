...
public class RegFarmMonitor extends BasicService implements Runnable, DataStore, ShutdownReceiver {
    ...
    private static final class UpdateVerifier implements Runnable {
        ...
        private static final String MY_VERSION = "16.11.05";

        private static final String MY_BUILDID = "201611240806";
    ...
    public static void main(String args[]) throws Exception {
        ...
        final String MonaLisa_version = "16.11.05-b201611240806";
        final String MonaLisa_vdate = "2016-11-24";
