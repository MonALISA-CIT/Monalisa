...
public class FarmMonitor extends RangePortUnicastRemoteObject implements MonitorUnit, Runnable, ShutdownReceiver {
    ...
    public static final String MonaLisa_version = "16.11.05-b201611240806";

    public static final String MonaLisa_vdate = "2016-11-24";

    static public final String VoModulesDir = "VoModules-v0.38";

    static public final String osgVoModulesDir = "OsgVoModules-v0.38";

    static public final String PNModulesDir = "PNModules-v0.22";
