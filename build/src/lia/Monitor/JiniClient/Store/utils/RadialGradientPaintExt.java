...
public class RadialGradientPaintExt implements Paint {
	 ...
	 */
	public RadialGradientPaintExt(Rectangle2D bounds, Color colors[], float I[]) {
		...
		gradientBounds.setRect((float) bounds.getX(), (float) bounds.getY(), (float) bounds.getWidth(), (float) bounds.getHeight());
