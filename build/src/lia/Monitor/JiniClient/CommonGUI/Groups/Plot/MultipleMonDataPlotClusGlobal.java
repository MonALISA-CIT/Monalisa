...
public class MultipleMonDataPlotClusGlobal implements LocalDataFarmClient, MultipleDataPlotter, ActionListener,
        ComponentListener, WindowListener, TimeSliderAdjustmentListener {

    /** Logger used by this class */
    private static final Logger logger = Logger.getLogger(MultipleMonDataPlotClusGlobal.class.getName());
    ...
    public MultipleMonDataPlotClusGlobal(DataPlotterParent parent, rcNode[] selectedNodes, Vector predicates,
            Vector clusters) {
        ...
        if (multipleFarms) {
            p = new newSimPlot("Cluster History Plot", "History Plot", "Local Time", " ", true);
            localTimeZone = true;
        } else {
            p = new newSimPlot("Cluster History Plot", "History Plot", "Service Local Time", " ", true);
