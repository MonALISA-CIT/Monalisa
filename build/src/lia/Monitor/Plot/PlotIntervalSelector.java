...
public class PlotIntervalSelector 
    ...
    private void initComponents() {
        ...
        panTabs.setPreferredSize(new java.awt.Dimension(300, 220));
        ...
        cbFixStartHour.setBounds(80, 50, 55, 24);
        
        panFixedTab.add(cbFixStartMin);
        cbFixStartMin.setBounds(140, 50, 55, 24);
        
        panFixedTab.add(cbFixEndSec);
        cbFixEndSec.setBounds(200, 120, 55, 24);
        
        panFixedTab.add(cbFixEndHour);
        cbFixEndHour.setBounds(80, 120, 55, 24);
        
        panFixedTab.add(cbFixEndMin);
        cbFixEndMin.setBounds(140, 120, 55, 24);
        
        panFixedTab.add(cbFixStartSec);
        cbFixStartSec.setBounds(200, 50, 55, 24);
        ...
        cbRelEndHour.setBounds(80, 120, 55, 24);
        
        panRelativeTab.add(cbRelEndMin);
        cbRelEndMin.setBounds(140, 120, 55, 24);
        
        panRelativeTab.add(cbRelEndSec);
        cbRelEndSec.setBounds(200, 120, 55, 24);
