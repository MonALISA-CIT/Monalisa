...
public class LisaFDTFilter extends GenericMLFilter {
    ...
    private static final Logger logger = Logger.getLogger(LisaFDTFilter.class.getName());
    ...
    private final Hashtable htLinksWithTransfers; // key=linkName(w/o dir), value=hash: key=transfName; value=FDTClient
